...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(_selectedPhotos.count<_maxSelectedCount) {
      if (indexPath.row == _selectedPhotos.count) {
        [cell.imageThumbnail setImage:[UIImage imageNamedFromMyBundle:@"visitor_ico_photograph.png"]];
          cell.imageThumbnail.contentMode = UIViewContentModeCenter;
        ...
        cell.nookDeleteBtn.hidden = YES;
          ...
          if ([_selectedPhotos[indexPath.row] isKindOfClass:[UIImage class]]) {
                ...
                [cell.imageThumbnail sd_setImageWithURL:_selectedPhotos[indexPath.row]];
          }
...
- (void)deleteBtnClik:(UIButton *)sender {
    ...
    if (self.deleteChooseImage != nil) {
        self.deleteChooseImage();
    }
