...
typedef void(^ChooseComplete)(void);//选择完成
typedef void(^DeleteChooseImage)(void);//删除选中的照片
...
@property (strong, nonatomic) NSMutableArray *selectedurls;    ///需要用到的模型数组
@property (strong, nonatomic) UICollectionView *collectionView;  ///选中图片排列集合view
@property (nonatomic , copy) ChooseComplete chooseComplete;
@property (nonatomic , copy) DeleteChooseImage deleteChooseImage;
